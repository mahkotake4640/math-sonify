...
impl DynamicalSystem for HindmarshRose {
    ...
    fn name(&self) -> &str { "Hindmarsh-Rose" }
    fn speed(&self) -> f64 { self.speed }

    fn deriv_at(&self, state: &[f64]) -> Vec<f64> {
        Self::deriv(state, self.a, self.b, self.c, self.d, self.r, self.s, self.x_rest, self.current_i)
    }
    ...
    fn step(&mut self, dt: f64) {
        ...
        rk4(&mut self.state, dt, |st| Self::deriv(st, a, b, c, d, r, s, x_rest, i));
